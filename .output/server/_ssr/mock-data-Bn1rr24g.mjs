//#region node_modules/.nitro/vite/services/ssr/assets/mock-data-Bn1rr24g.js
var SPORTS = [
	"Football",
	"Cricket",
	"Box Cricket",
...
var MOCK_NOTIFICATIONS = [
	{
		...
		desc: "GO-8421 · Football · Sat 6 PM",
		time: "2h ago",
		unread: true
	},
	{
		...
		desc: "Use code GAMEON20 on weekend slots.",
		time: "1d ago",
		unread: true
	},
	{
		...
		desc: "Don't forget — Cricket at 4 PM.",
		time: "1d ago",
		unread: false
	},
	{
		id: 4,
		type: "tournament",
		title: "WPL registrations open",
		desc: "Prize pool ₹25,000. Secure your spot.",
		time: "3d ago",
		unread: false
	},
	{
		id: 5,
		type: "maintenance",
		title: "Pitch 1 maintenance",
		desc: "Closed Mon 6–10 AM for re-turfing.",
		time: "5d ago",
		unread: false
	}
];
...
Array.from({ length: 7 }, (_, d) => Array.from({ length: 17 }, (_, h) => {
	return Math.min(1, (h >= 12 && h <= 16 ? .7 : .3) + (d >= 5 ? .2 : 0) + Math.random() * .3);
}));
var MOCK_COUPONS = [
	{
		code: "WELCOME10",
...
var MOCK_COUPON_USAGE = [
	{
		id: "CU-001",
		couponCode: "WELCOME10",
		customer: "Aarav Deshmukh",
		bookingId: "GO-8421",
...
//#endregion
export { MOCK_CUSTOMERS as a, MOCK_PAYMENTS as c, MOCK_COUPON_USAGE as i, SPORTS as l, MOCK_BOOKINGS as n, MOCK_MATCHES as o, MOCK_COUPONS as r, MOCK_NOTIFICATIONS as s, ADMIN_STATS as t };
